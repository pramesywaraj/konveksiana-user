                    ...
                    <div className="col-12 col-sm-12 col-md-6 col-lg-4 py-3">
                        <div className=" mb-3">                                        
                            <div className="card-body">        
                                ...
                                <p className="card-desc">Konveksiana akan memberikan garansi untuk setiap pemesanan, sehingga tidak perlu lagi takut apabila pesanan yang sampai tidak sesuai dengan spesifikasi yang telah disepakati.</p>
                            </div>
                        </div>
                    </div>
